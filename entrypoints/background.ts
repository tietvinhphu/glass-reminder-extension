...
export default defineBackground(() => {
  // Đăng ký alarm handler cho background script lifecycle
  registerAlarmHandler();

  // Nhận messages từ overlay window (ALARM_CONFIRMED + RESIZE_WINDOW)
  // Wrap trong defineBackground callback để tránh top-level side effects,
  // giúp unit test có thể import file này mà không cần mock toàn bộ browser API.
